...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true)
    try {
      const response = await axios.post(`${API}/api/Auth/Singup`, formData)
      ...
      {registered ? (
        <div className="w-full max-w-md relative z-10 animate-fade-in">
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-green-500 to-emerald-400 mb-5 shadow-lg shadow-green-500/30 transition-transform duration-300 hover:scale-110">
          ...
          <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-700/40 rounded-2xl p-8 shadow-2xl shadow-black/40 text-center space-y-4">
            ...
            <p className="text-slate-400 text-sm">
              ...
              <button onClick={() => setRegistered(false)} className="text-blue-400 hover:text-blue-300 font-medium transition-colors duration-200">
                try again
              </button>
            </p>
          </div>
          ...
          <div className="space-y-5">
            ...
            <div className="group">
              ...
              <div className="relative">
                <span className={`absolute left-3.5 top-1/2 -translate-y-1/2 transition-colors duration-300 ${focused === 'username' ? 'text-blue-400' : 'text-slate-500'}`}>
